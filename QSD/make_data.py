...
def main():
    ...
    ee = calc_ee(aiaj,Ne)
    print("\n")
    print("# time evolution of nA nB ee")
#    print(0,0.0,nA,nB,ee)
    list_timeevol.append([0,0.0,nA,nB,ee])
    ...
    for step in range(1,Nstep+1):
        ...
        nA,nB = calc_nA_nB_from_ni(ni)
        ee = calc_ee(aiaj,Ne)
#        print(step,dt*step,nA,nB,ee)
        list_timeevol.append([step,dt*step,nA,nB,ee])

    list_dist_ee = []
    print("\n")
    print("# distance depndence of ee")
